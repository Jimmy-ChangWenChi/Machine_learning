...
X_train, X_test, Y_train, Y_test = pp.split_train_test(X_AGE, Y_MALE_Height, train_size=0.8)
# =============================================================================
...
Y_pred = regressor[][].fit(X_train,Y_train).predict(X_test) #第一組[] 是控制身高體重, 第二組[]是控制男生女生
